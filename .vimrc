...
set smartcase " 大文字と小文字が混在したワードで検索を行なった場合に限り区別する
...
source ~/.vimrc.keymap
" メモ
" カスタムキーマップのinoremap <C-k>がneosnippetの<c-k>と競合していたので
" sourceを一番最後にした、neosnippetの方で不具合があるようであれば再度修正する
